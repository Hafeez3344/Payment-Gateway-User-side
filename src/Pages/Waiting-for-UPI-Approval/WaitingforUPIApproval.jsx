...
const WaitingforUPIApproval = () => {
  ...
  return (
    <div>
      <Header />
      <div className="flex items-center justify-center px-4" style={{minHeight: `${containerHeight}px`}}>
        <div className="h-[400px] p-8 border-l-4 border-t-2 border-t-gray-300 border-r-2 border-r-gray-300 border-b-2 border-b-gray-300 border-[--main] w-full max-w-lg">
          ...
          <div className="flex justify-center items-center lg:w-full mt-4">
            <div className="text-nowrap w-[max-content] flex items-center justify-center border-2 border-green-700 mt-10 h-[40px] rounded py-2 px-4 text-green-700 text-[16] font-[600]">
              ...
              <span className="ml-2 text-black">15:00</span>
            </div>
          </div>
          ...
          {/* Fixed issue for mobile view */}
          <p className="text-center  font-bold text-xs sm:text-sm mb-2 px-2 sm:px-4 break-words">
            Can't pay with UPI?{" "}
